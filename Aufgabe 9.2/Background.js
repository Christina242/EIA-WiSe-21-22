...
(function (Aufgabe9_2) {
    ...
    Aufgabe9_2.drawTrees1 = drawTrees1;
    ...
    Aufgabe9_2.drawTree2 = drawTree2;
    function drawSquirrel(_position) {
        Aufgabe9_2.crc2.fillStyle = "#B47D49";
        Aufgabe9_2.crc2.resetTransform();
        Aufgabe9_2.crc2.save();
        Aufgabe9_2.crc2.translate(_position.x, _position.y);
        // body
        Aufgabe9_2.crc2.beginPath();
        Aufgabe9_2.crc2.ellipse(30, 70, 20, 40, 0, 10, 20);
        Aufgabe9_2.crc2.closePath();
        Aufgabe9_2.crc2.fill();
        // arm1
        Aufgabe9_2.crc2.beginPath();
        Aufgabe9_2.crc2.ellipse(3, 40, 8, 18, 15, 10, 20);
        Aufgabe9_2.crc2.closePath();
        Aufgabe9_2.crc2.fill();
        // arm2
        Aufgabe9_2.crc2.beginPath();
        Aufgabe9_2.crc2.ellipse(2, 55, 8, 18, 17, 10, 20);
        Aufgabe9_2.crc2.closePath();
        Aufgabe9_2.crc2.fill();
        // leg1
        Aufgabe9_2.crc2.beginPath();
        Aufgabe9_2.crc2.ellipse(3, 90, 8, 18, 20, 10, 20);
        Aufgabe9_2.crc2.closePath();
        Aufgabe9_2.crc2.fill();
        // leg2
        Aufgabe9_2.crc2.beginPath();
        Aufgabe9_2.crc2.ellipse(7, 105, 8, 20, 20, 10, 20);
        Aufgabe9_2.crc2.closePath();
        Aufgabe9_2.crc2.fill();
        // tail
        Aufgabe9_2.crc2.beginPath();
        Aufgabe9_2.crc2.ellipse(50, 80, 10, 30, 10, 10, 20);
        Aufgabe9_2.crc2.closePath();
        Aufgabe9_2.crc2.fill();
        // head
        let rHead = 17;
        Aufgabe9_2.crc2.beginPath();
        Aufgabe9_2.crc2.arc(28, 20, rHead, 0, 2 * Math.PI);
        Aufgabe9_2.crc2.closePath();
        Aufgabe9_2.crc2.fill();
        // ear1
        Aufgabe9_2.crc2.beginPath();
        Aufgabe9_2.crc2.ellipse(34, 5, 7, 15, 10, 10, 20);
        Aufgabe9_2.crc2.closePath();
        Aufgabe9_2.crc2.fill();
        // ear2
        Aufgabe9_2.crc2.beginPath();
        Aufgabe9_2.crc2.ellipse(30, 5, 7, 15, 9, 10, 20);
        Aufgabe9_2.crc2.closePath();
        Aufgabe9_2.crc2.fill();
        // eye
        let rEye = 2;
        Aufgabe9_2.crc2.beginPath();
        Aufgabe9_2.crc2.arc(25, 14, rEye, 0, 2 * Math.PI);
        Aufgabe9_2.crc2.lineWidth = 2;
        Aufgabe9_2.crc2.closePath();
        Aufgabe9_2.crc2.fillStyle = "#000000";
        Aufgabe9_2.crc2.fill();
        Aufgabe9_2.crc2.restore();
    }
    Aufgabe9_2.drawSquirrel = drawSquirrel;
    function drawLeafs() {
        let nLeafs = 50;
        let rLeafs = 15;
    ...
    Aufgabe9_2.drawLeafs = drawLeafs;
    ...
    Aufgabe9_2.drawRoundLeafs = drawRoundLeafs;
